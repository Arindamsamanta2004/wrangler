...
## Data Size and Time Duration Support

### Byte Size Format
The wrangler now supports parsing of data sizes with the following units:
- B (Bytes)
- KB (Kilobytes)
- MB (Megabytes)
- GB (Gigabytes)
...
Example values: `1024B`, `512KB`, `2.5MB`, `1GB`, `1.5TB`

### Time Duration Format
Time durations can be specified using these units:
- ms (milliseconds)
- s (seconds)
- m (minutes)
- h (hours)
...
Example values: `100ms`, `30s`, `5m`, `2h`, `7d`

### Aggregate Stats Directive
The `aggregate-stats` directive allows you to calculate totals for byte sizes and time durations.
